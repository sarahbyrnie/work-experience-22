    ...
    public static void main(String[] args) {
        ...
        for (int queryDate = 220418; queryDate <= 220424; queryDate++) {
           System.out.println("Querying " + days[queryDate - 220418] + "...");
            ...
            try {
                BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("/data/inputs/NR-full-timetable.cif")));
                String line;
        ...
        try {
            File file = new File("/data/outputs/station_data.txt");
